...
module.exports = function (app) {
    ...
    app.post('/wishlistItems', cors(corsOptions), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var items;
    ...
    app.get('/wishlistItems', cors(corsOptions), function (_req, res) { return __awaiter(_this, void 0, void 0, function () {
        var items;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    app.get('/wishlistItems/:_id', cors(corsOptions), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var item;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    app.put('/wishlistItems/:_id', cors(corsOptions), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var item;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    app.delete('/wishlistItems/:_id', cors(corsOptions), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
