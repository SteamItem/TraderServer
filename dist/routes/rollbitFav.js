...
module.exports = function (app) {
    ...
    app.post('/rollbitFav/add', cors(corsOptions), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rollbitFavController.addToFavorites(req.body.name)];
                case 1:
                    items = _a.sent();
                    res.send(items);
                    return [2 /*return*/];
    ...
    app.post('/rollbitFav/remove', cors(corsOptions), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var items;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rollbitFavController.removeFromFavorites(req.body.name)];
                case 1:
                    items = _a.sent();
                    res.send(items);
                    return [2 /*return*/];
