...
const wishlistItem = { wishlist_id: "harun", site_id: EnumSite.Rollbit, appid: EnumSteamApp.Dota, name: "SSG 08 | Bloodshot (Field-Tested)"};
const dummyWishlistItem = { wishlist_id: "dummy", site_id: EnumSite.Rollbit, appid: EnumSteamApp.Dota, name: "Dummy"};
